...
{
    mat3 results;
    results.elements[0][0] = m1.elements[0][0] + m2.elements[0][0];
    results.elements[0][1] = m1.elements[0][1] + m2.elements[0][1];
    results.elements[0][2] = m1.elements[0][2] + m2.elements[0][2];
    results.elements[1][0] = m1.elements[1][0] + m2.elements[1][0];
    results.elements[1][1] = m1.elements[1][1] + m2.elements[1][1];
    results.elements[1][2] = m1.elements[1][2] + m2.elements[1][2];
    results.elements[2][0] = m1.elements[2][0] + m2.elements[2][0];
    results.elements[2][1] = m1.elements[2][1] + m2.elements[2][1];
    results.elements[2][2] = m1.elements[2][2] + m2.elements[2][2];
...
inline constexpr vec2 operator*(const mat3& m, vec2 v) noexcept
{
    return { m.elements[0][0] * v.x + m.elements[1][0] * v.y + m.elements[2][0], m.elements[0][1] * v.x + m.elements[1][1] * v.y + m.elements[2][1] };
}
